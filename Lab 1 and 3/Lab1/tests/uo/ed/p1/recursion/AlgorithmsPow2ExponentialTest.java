...
public class AlgorithmsPow2ExponentialTest {

	/**
	 * GIVEN: a negative exponent
	 * <p>
	 * WHEN: calling pow2Exponential
	 * <p>
	...
	void negativeParameter() {
		int exp = -1;
		try {
			Algorithms.pow2Exponential(exp);
	...
	void pow2ExponentialSequence() {
		...
		for (int i = 0; i < 8; i++) {
			assertEquals(pow2Sequence[i], Algorithms.pow2Exponential(i));
		}
	}
