...
public class AlgorithmsPow2LogarithmicTest {

	/**
	 * GIVEN: a negative exponent
	 * <p>
	 * WHEN: calling pow2Logarithmic
	 * <p>
	...
	void negativeParameter() {
		int exp = -1;
		try {
			Algorithms.pow2Logarithmic(exp);
	...
	void pow2ExponentialSequence() {
		...
		for (int i = 0; i < 8; i++) {
			assertEquals(pow2Sequence[i], Algorithms.pow2Logarithmic(i));
		}
	}
